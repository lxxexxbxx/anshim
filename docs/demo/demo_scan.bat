@echo off
REM AnShim 데모 실행 스크립트 (Windows)
REM 이 스크립트는 취약한 Flask 앱을 스캔하고 HTML 리포트를 자동으로 엽니다.
...
REM 2. 데모 대상 경로 설정
set DEMO_TARGET=%~dp0demo_target
